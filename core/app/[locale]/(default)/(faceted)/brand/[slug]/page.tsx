...
import { ScrollLink } from '~/belami/components/scroll-link';
import { ScrollableLink } from '~/belami/components/scrollable-link';
      ...
      {brand.defaultImage && brand.defaultImage.urlOriginal ? (
        <section className="mt-8 bg-gray-50 px-4 py-8 text-center md:mb-8">
          ...
          <div className="mt-4 inline-flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href={`${brand.path}#catalog`} prefetch={false} className="flex space-x-2 rounded bg-brand-700 px-4 py-2 uppercase text-white">
            ...
            {/* <Link href={`${brand.path}?is_new=true#catalog`} replace prefetch={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            <ScrollableLink href={`${brand.path}?is_new=true#catalog`} replace={true} scroll={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="21"
                height="20"
                viewBox="0 0 21 20"
            ...
            {/* <Link href={`${brand.path}?on_sale=true#catalog`} prefetch={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            <ScrollableLink href={`${brand.path}?on_sale=true#catalog`} scroll={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
            ...
            {/* <Link href={`/search?brand_name[0]=${encodeURIComponent(brand?.name ?? '')}`} className="flex space-x-2 rounded bg-brand-700 px-4 py-2 uppercase text-white"> */}
            <Link href={`${brand.path}#catalog`} prefetch={true} className="flex space-x-2 rounded bg-brand-700 px-4 py-2 uppercase text-white">
              <span>Shop All {brand.name}</span>
            </Link>
            {/* <Link href={`/search?brand_name[0]=${encodeURIComponent(brand?.name ?? '')}&is_new=true`} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            {/* <Link href={`${brand.path}?is_new=true#catalog`} replace prefetch={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            <ScrollableLink href={`${brand.path}?is_new=true#catalog`} replace={true} scroll={true} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="21"
                height="20"
                viewBox="0 0 21 20"
            ...
            {/* <Link href={`/search?brand_name[0]=${encodeURIComponent(brand?.name ?? '')}&on_sale=true`} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            {/* <Link href={`${brand.path}?on_sale=true#catalog`} prefetch={false} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white"> */}
            <ScrollableLink href={`${brand.path}?on_sale=true#catalog`} scroll={true} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
            ...
            <ScrollLink href={`${brand.path}#catalog`} className="flex space-x-2 rounded bg-brand-700 px-4 py-2 uppercase text-white">
              <span>Shop All {brand.name}</span>
            </ScrollLink>
            <ScrollLink href={`${brand.path}?is_new=true#catalog`} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="21"
                height="20"
                viewBox="0 0 21 20"
            ...
            <ScrollLink href={`${brand.path}?on_sale=true#catalog`} className="flex space-x-2 rounded bg-brand-400 px-4 py-2 uppercase text-white">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
