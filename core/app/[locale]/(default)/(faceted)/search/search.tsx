...
export const Search = ({ query, promotions, useDefaultPrices = false, priceMaxRules = null, userContext = null }: any) => {
  ...
  return (
    <InstantSearchNext
      ...
      insights={true}
    >
      <Configure ruleContexts={ruleContexts} analyticsTags={analyticsTags} maxFacetHits={100} />
      <VirtualSearchBox />
      {showSidebar &&
