...
import AccountPopup from './(tabs)/_components/account-popup';
...
export default async function Account() {
  ...
  return (
    <>
      <AccountPopup sessionUser={sessionUser} customerGroupDetails={customerGroupDetails} />
