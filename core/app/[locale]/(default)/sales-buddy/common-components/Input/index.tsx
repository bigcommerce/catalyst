  ...
  ({ className, children, error = false, icon, type = 'text', ...props }, ref) => {
    ...
    return (
      <div className='relative'>
        <input
          className={`
            peer w-full border-2 border-gray-200 px-4 py-2.5 text-base placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/20 disabled:bg-gray-100 disabled:hover:border-gray-200
