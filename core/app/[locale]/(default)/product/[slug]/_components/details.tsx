...
export const Details = ({
  ...
  console.log('fdskjafgdfaks');

  return (
    <div className="">
      <div className="sticky-add-to-cart !z-[100]">
        {showStickyHeader && (
          <>
            <div className="fixed left-0 right-0 top-0 z-[9999999] hidden border-b border-gray-200 bg-white shadow-2xl xl:block">
                                ...
                                if (option.__typename === 'MultipleChoiceOption') {
                                  ...
                                  return (
                                    <span key={option.entityId}>
                                      ...
                                      <span className="text-[15px] text-[#7F7F7F]">
                                        {' '}
                                        {selectedValue}
                                      </span>
