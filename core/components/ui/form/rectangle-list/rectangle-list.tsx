        ...
        {items.map((item) => {
          ...
          return (
            <RadioGroupPrimitive.Item
              ...
              {...itemProps}
              className={cn(
                'border-2 px-6 py-2.5 font-semibold text-black hover:border-primary focus-visible:outline-hidden focus-visible:ring-4 focus-visible:ring-primary/20 disabled:border-gray-100 disabled:text-gray-400 disabled:hover:border-gray-100 data-[state=checked]:border-primary',
                error &&
