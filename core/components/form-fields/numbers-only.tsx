  ...
  return (
    <Field className="relative space-y-2" name={name}>
      ...
      <div className="relative h-7">
        {field.isRequired && (
          <FieldMessage
            className="inline-flex w-full text-xs font-normal text-error-secondary validation-error-5"
            match="valueMissing"
          >
            {t('empty')}
          </FieldMessage>
        ...
        <FieldMessage
          className="inline-flex w-full text-xs font-normal text-error-secondary validation-error-6"
          match="typeMismatch"
        >
          {t('numbersOnly')}
        </FieldMessage>
        {Boolean(field.minNumber) && (
          <FieldMessage
            className="inline-flex w-full text-xs font-normal text-error-secondary validation-error-7"
        ...
        {Boolean(field.maxNumber) && (
          <FieldMessage
            className="inline-flex w-full text-xs font-normal text-error-secondary validation-error-8"
            match="rangeOverflow"
          >
