          ...
          !!filteredItems[0]?.link?.href ? (
            <Link href={filteredItems[0]?.link.href}>
              {!!filteredItems[0]?.imageMobileSrc ? (
                <>
                  <img src={filteredItems[0]?.imageSrc} alt={filteredItems[0]?.imageAlt} className="mega-banner-image hidden md:block" />
                  <img src={filteredItems[0]?.imageMobileSrc} alt={filteredItems[0]?.imageAlt} className="mega-banner-image-mobile block md:hidden" />
                </>
              ) : (
