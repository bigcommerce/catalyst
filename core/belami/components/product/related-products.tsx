  ...
  return (
    <article data-id={hit.objectID} className="w-full product flex flex-col h-full border border-gray-300 rounded-none">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="mt-4 p-4 hidden lg:block">
          <button type="button" className="flex items-center justify-center space-x-2 px-4 w-full h-10 rounded border border-[#B4DDE9] cursor-pointer uppercase" onClick={(e) => alert('Coming Soon!')}>
            ...
            <span className='font-[500] leading-[32px] text-[14px] tracking-[1.25px] text-[#002A37]'>Quick View</span>
          </button>
        </div>
      </div>
    </article>
