...
/**
 * Build a Customer Login API JWT which can be used in auth.ts to log in a customer
 ...
 * @param {number} [channelId] - Optional channel ID that the customer will be logged into
 * @param {string} [redirectTo] - Optional relative URL to redirect to after successful login
