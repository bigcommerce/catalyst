/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 8355e1d8f014b6864825f4c02110846a)
// Runtime types generated with workerd@1.20250617.0 2024-12-30 enable_weak_ref,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		"catalyst-test-jm": KVNamespace;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* catalyst-test-jm */;
		ASSETS: Fetcher;
	}
}
