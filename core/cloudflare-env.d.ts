/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fa52a854b9f6e50eedcb6dc5985eef48)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* catalyst */;
		ASSETS: Fetcher;
	}
}
