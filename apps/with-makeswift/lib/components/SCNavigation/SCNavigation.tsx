...
export function SCNavigation({
  ...
  return (
    <>
      ...
      >
        <div className="relative w-full px-6 py-2 md:px-8 lg:justify-end lg:px-12">
          <div
          ...
          >
            ...
            <NavigationMenu.Root className="justify-left hidden flex-1 lg:flex" delayDuration={0}>
            ...
            <div className="flex gap-1 [&>a:hover]:opacity-50 [&>a]:p-3 [&>a]:transition-opacity">
