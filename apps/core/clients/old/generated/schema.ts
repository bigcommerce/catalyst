...
export type Error = (ValidationError) & { __isUnion?: true }
...
export type SubmitContactUsError = (ValidationError) & { __isUnion?: true }
...
export interface MutationGenqlSelection{
    ...
    /** Contact us mutation. */
    submitContactUs?: (SubmitContactUsResultGenqlSelection & { __args: {
    /** The content of the contact us form. */
    input: SubmitContactUsInput, 
    /** The reCaptchaV2 token. */
    reCaptchaV2?: (ReCaptchaV2Input | null)} })
    /** The wishlist mutations. */
...
/** Order number */
orderNumber?: (Scalars['String'] | null),
/** Customer phone number */
phoneNumber?: (Scalars['String'] | null),
/** RMA number */
rmaNumber?: (Scalars['String'] | null)}


/** Error that occurred when submitting the contact us email */
export interface SubmitContactUsErrorGenqlSelection{
    on_ValidationError?:ValidationErrorGenqlSelection,
...
pageEntityId: Scalars['Int']}


/** Result of submitting contact us form */
export interface SubmitContactUsResultGenqlSelection{
    /** List of errors that occurred executing the mutation. */
    errors?: SubmitContactUsErrorGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
name?: (Scalars['String'] | null)}
    ...
    const Error_possibleTypes: string[] = ['ValidationError']
    ...
    const SubmitContactUsError_possibleTypes: string[] = ['ValidationError']
    export const isSubmitContactUsError = (obj?: { __typename?: any } | null): obj is SubmitContactUsError => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSubmitContactUsError"')
      return SubmitContactUsError_possibleTypes.includes(obj.__typename)
    }
    


    const SubmitContactUsResult_possibleTypes: string[] = ['SubmitContactUsResult']
    export const isSubmitContactUsResult = (obj?: { __typename?: any } | null): obj is SubmitContactUsResult => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSubmitContactUsResult"')
      return SubmitContactUsResult_possibleTypes.includes(obj.__typename)
    }
