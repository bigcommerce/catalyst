...
import { getDeploymentErrorMessage } from './deployment-errors';

describe('getDeploymentErrorMessage', () => {
  test('code 10 — internal error', () => {
    expect(getDeploymentErrorMessage(10)).toBe(
  ...
  test('code 20 — bundle retrieval failure', () => {
    expect(getDeploymentErrorMessage(20)).toBe(
  ...
  test('code 30 — bundle extraction failure', () => {
    expect(getDeploymentErrorMessage(30)).toBe(
  ...
  test('code 40 — build output validation failure', () => {
    const message = getDeploymentErrorMessage(40);
  ...
  test('code 50 — deployment failure', () => {
    expect(getDeploymentErrorMessage(50)).toBe(
  ...
  test('code 60 — deployment URL resolution failure', () => {
    expect(getDeploymentErrorMessage(60)).toBe(
  ...
  test('unknown code — fallback message', () => {
    expect(getDeploymentErrorMessage(99)).toBe(
