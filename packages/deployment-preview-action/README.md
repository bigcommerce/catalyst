...
| Name | Kind | Notes |
| --- | --- | --- |
| `BIGCOMMERCE_PREVIEW_PROJECT_UUID` | variable | From step 1 |
| `BIGCOMMERCE_STORE_HASH` | variable | From your control panel URL |
| `BIGCOMMERCE_ACCESS_TOKEN` | secret | Needs `store_infrastructure_projects_manage` and `store_infrastructure_deployments_manage` |
...
> environment-scoped `vars.BIGCOMMERCE_PREVIEW_PROJECT_UUID` would resolve to an
